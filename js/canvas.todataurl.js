// Original by Hans Schmucker at	https://code.google.com/p/todataurl-png-js/
// Modifed by Javier Sarramian
...
(function(){
        ...
        if (HTMLCanvasElement != undefined) {
	        var toDataURL_canvas_backup=HTMLCanvasElement.prototype.toDataURL;
	        
	        HTMLCanvasElement.prototype.toDataURL=function(type){
	
                var res=toDataURL_canvas_backup.apply(this,arguments);
                if(res == "data:,"){
                        HTMLCanvasElement.prototype.toDataURL=toDataURL;
                        return this.toDataURL();
                }else{
                        HTMLCanvasElement.prototype.toDataURL=toDataURL_canvas_backup;
                        return res;
                }
	        }
        }
        ...
        if (HTMLImageElement != undefined) {
	        HTMLImageElement.prototype.toDataURL=function(type){
	        	HTMLImageElement.prototype.toDataURL=toDataURL;
        		return this.toDataURL();
	        }
        }
        */
